...
//   // Start the timer when the first answer is submitted
//   useEffect(() => {
//     if (questionCount === 0) {
//       return;
//     }
...
//     // Stop the timer after 5 minutes or 100 questions
...
//       clearInterval(timerId);
//     };
//   }, [timeRemaining, questionCount, score]);

//   return (
//     <div className="flex items-center justify-center h-screen bg-blue-500">
//         <button
//       className="reset-button text-gray-800 bg-yellow-400 border border-gray-700 rounded-3xl px-4 py-2 text-lg md:text-2xl lg:text-3xl hover:bg-yellow-600 hidden sm:block absolute top-0 right-0 mt-4 mr-4"
//       onClick={() => {
//         setScore(0);
//         setQuestionCount(0);
...
//           <input type="text" className="ml-2 border border-gray-400 rounded-md p-1" />
//         </label>
